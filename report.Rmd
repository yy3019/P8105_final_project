...
We thought we were fine already, but not yet. The built in function `fragility.index` seemed to have consumed tons of workspace in R studio, so we're not allowed to simply map the function to the dataset. Instead, we need to do it one by one. 
