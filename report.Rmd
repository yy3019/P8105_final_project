...
Now we filter and finally create a dataset.
...
Given the limited information we obtained so far, we are allowed to create general descriptive table and bar plot of FI corresponding to the disease conditions.
