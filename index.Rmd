...
<h3 style="text-align: center;" markdown="1">Exploring the fragility index and learning about clinical trials</h3>
...
At first, we set the main target to autoimmune disorder related clinical trials; however, the resulting dataset wasn't big enough for us to conduct further analysis. Therefore, we broadened our criteria to US based phase III clinical trials. 
...
For detailed results, analysis and outout, please refer to our [report](report.html).

# Fun Facts about the project

1. This project utilized 5 customly created functions
2. The XML for all publicly available clinical trial data is over 800mb large
3. To date, there have been 158 clinical trials based in Hawaii, and only 10 in Wyoming
4. Alamaba has the 2nd most industry backed clinical trials in the US